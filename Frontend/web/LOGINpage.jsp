...
<body>
    ...
    <div class="login-container">
        ...
        <a href="changePass.jsp" class="change-pass">Lupa Password?</a>
        ...
        <% 
            ...
            if (username != null && password != null) {
                if (("test123".equals(username) && "12345".equals(password))
                || ("owner123".equals(username) && "112233".equals(password))) {
                    if ("test123".equals(username)){
                        role = "karyawan";
                    }else if("owner123".equals(username)){
                        role = "owner";
                    }
